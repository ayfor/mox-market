  ...
  return (
    <nav className="flex items-center">
      ...
      <div className="flex gap-x-6 text-sm/6 text-gray-950 max-lg:hidden dark:text-white">
        <Link href="/" className="hover:text-mox-sapphire-light">
          Dashboard
        </Link>
        <Link href="/import" className="hover:text-mox-sapphire-light">
          Import
        </Link>
        <Link href="/about" className="hover:text-mox-sapphire-light">
          About
        </Link>
      </div>
    </nav>
